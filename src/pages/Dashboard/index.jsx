      ...
      <div className="dashboard">
        <div className="container">
          <div className="dashboard-invoices">
            <Analytic />
            <div className="w-full flex flex-col items-start justify-between gap-2 px-3 mt-8 mb-20">
              ...
              <div className="wrapper-balance  w-full flex items-start  justify-between py-3 gap-2 px-1 mt-8 mb-20">
                ...
                >
                  <div className="details flex flex-col items-start justify-between">
                    <h4 className="nav-title text-sm font-bold">
                      Balance Details
                    </h4>
                  ...
                  <div className="w-full flex flex-wrap gap-3">
                    ...
                    >
                      ...
                      <strong className="nav-title font-medium text-sm">
                        $14,557
                      </strong>
                    </div>
                    <div
